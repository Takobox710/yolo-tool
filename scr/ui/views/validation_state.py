...
from scr.services.path_service import resolve_project_path, simplified_model_path
from scr.ui.qt import QMessageBox
from scr.ui.views.validation_helpers import dataset_yaml_root, validation_val_override
from scr.ui.views.validation_models import build_validation_model_choices
from scr.ui.views.validation_sources import (
...
def update_source_mode(page, value):
    ...
    page.source_box.setVisible(single_file_mode or dataset_source_mode)
    ...
    if dataset_source_mode:
        page._configure_source_combo(
            ...
            or page.app.settings.get("validation", {}).get("source_scope", "全部图片"),
...
def handle_source_input_changed(page):
    ...
    if page.mode_combo.currentText() == "图片/视频文件夹":
