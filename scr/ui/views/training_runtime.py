...
from scr.services.training_service import build_train_command, repair_validation_path_if_needed
from scr.ui.dialogs import CommandDialog
from scr.ui.qt import QDialog


def _spawn_logged_process():
    module = import_module("scr.ui.views.training")
    return getattr(module, "spawn_logged_process", spawn_logged_process)


def _stop_process():
    module = import_module("scr.ui.views.training")
    return getattr(module, "stop_process", stop_process)
