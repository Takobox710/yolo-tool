...
from src.ui.shared.page_base import BasePage, ImageView, _IMAGE_SUFFIXES
...
class PreviewTab(BasePage):
    ...
    def on_setting_changed(self, keys, value):
        if keys == ("paths", "images_dir"):
            ...
            self.image_edit.setText(self.display_path(value))
            ...
            self.label_edit.setText(self.display_path(value))
